...
{
    auto z_cal = proportion_statistic(sample_proportion, sample_size, proportion);
    auto p_value = proportion_p_value(z_cal, comparison);

    auto z_crit = proportion_critical_value(confidence_level, comparison);
